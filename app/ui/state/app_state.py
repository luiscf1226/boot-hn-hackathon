...
class AppState:
    ...
    def is_waiting_for_input(self) -> bool:
        ...
        return (
            self.setup_waiting_for_api_key
            or self.setup_step == "model_selection"
            or self.init_waiting_for_path
            or self.clean_waiting_for_action
            or self.commit_waiting_for_confirmation
            or self.review_waiting_for_confirmation
            or self.explain_waiting_for_input
        )
